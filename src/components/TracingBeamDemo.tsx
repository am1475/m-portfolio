              ...
              <div className="md:w-1/2 lg:w-1/2 flex justify-end md:pl-12"> {/* Increased image container width */}
                <a href={item.link} target="_blank" rel="noopener noreferrer">
                  <Image
                    ...
                    className="rounded-lg object-cover w-full h-auto max-w-[800px]"
                    width={800}
                    height={600}
                  />
                </a>
...
const projects = [
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dqm8rxpzq/image/upload/v1732171856/Screenshot_2024-11-21_121634_iqs1uj.png",
    link: "https://github.com/am1475/advance-tracker",
  },
  {
